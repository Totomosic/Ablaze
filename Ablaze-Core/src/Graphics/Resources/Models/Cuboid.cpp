...
namespace Ablaze
{
	...
	Cuboid::Cuboid(const String& name, const maths::vec3& size, const Color& color) : Model(name, new VertexBuffer(24 * sizeof(Vertex), BufferLayout::Vertex()), new IndexBuffer(6 * 6 * sizeof(GLuint)), size)
	{
		Create(color);
	}
