...
namespace Ablaze
{
	...
	public:
		...
		GameObject(GameObject* parent, bool preserveCurrentPosition = false);
		GameObject(); 				

		virtual void Destroy();
		virtual GameObject* Clone() const;
		virtual void MakeChildOf(GameObject* parent, bool preserveCurrentPosition = false);
		...
		static GameObject* Instantiate(const GameObject* prefab, GameObject* parent);
		static GameObject* Instantiate(const GameObject* prefab, GameObject* parent, const maths::vec3& worldPosition);
