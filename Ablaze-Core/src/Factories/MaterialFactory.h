...
namespace Ablaze
{
	...
	public:
		...
		static Material* Fabricate(const Color& color, const Shader* const shader, const String& sampler, Texture* texture = nullptr, bool depth = true, bool blend = true, GLenum blendSrcFunc = GL_SRC_ALPHA, GLenum blendDstFunc = GL_ONE_MINUS_SRC_ALPHA);
		static Material* Fabricate(const Color& color, const Shader* const shader, const String& sampler, const String& textureName, bool depth = true, bool blend = true, GLenum blendSrcFunc = GL_SRC_ALPHA, GLenum blendDstFunc = GL_ONE_MINUS_SRC_ALPHA);
